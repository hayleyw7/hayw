describe('color and typography contracts', () => {
  ...
  it('uses the intended base colors for light and dark sections', () => {
    ...
    cy.get('#one').should('have.css', 'background-color', 'rgb(255, 255, 255)')
    cy.get('#two').should('have.css', 'background-color', 'rgb(51, 60, 68)')
    cy.get('#two h2').should('have.css', 'color', 'rgb(245, 247, 248)')
    cy.get('#three h2').should('have.css', 'color', 'rgb(109, 127, 146)')
  })
